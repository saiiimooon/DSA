// --- Slide Navigation Logic ---
        ...
        function resetLL() {
            ...
            document.getElementById('ll-text').style.color = "var(--text-main)";
        }

        // --- Slide 4: LR Rotation Animation ---
        function animateLR_Step1() {
            // Left rotate child (10 goes down-left, 20 goes up)
        ...
        function animateLR_Step2() {
            // Right rotate parent (30 goes down-right, 20 goes to root)
        ...
        function resetLR() {
            ...
            document.getElementById('lr-text').style.color = "var(--text-main)";
        }